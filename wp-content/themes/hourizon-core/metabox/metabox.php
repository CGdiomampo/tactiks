...
function cmb_sample_metaboxes( array $meta_boxes ) {
	 ...
	 */
	$meta_boxes['prod'] = array(
		'id'         => 'prod',
		'title'      => __( 'Product Metabox', 'cmb' ),
		...
		'fields'     => array(
			...
			array(
				'name'    => __( 'Select Product Layout', 'cmb' ),
			...
			array(
				...
				'id'   => $prefix . 'head_image',
				'type' => 'file',
			),
			
			array(
				'name'    => __( 'Features', 'cmb' ),
				'desc'    => __( 'field description (optional)', 'cmb' ),
				'id'      => $prefix . 'features_wysiwyg',
				'type'    => 'wysiwyg',
			...
			array(
				'name'    => __( 'Videos', 'cmb' ),
				'desc'    => __( 'field description (optional)', 'cmb' ),
				'id'      => $prefix . 'vid_wysiwyg',
				'type'    => 'wysiwyg',
				'options' => array( 'textarea_rows' => 15, ),
			),
			*/
			array(
				'name' => __( 'Shop Link', 'cmb' ),
				'desc' => __( 'field description (optional)', 'cmb' ),
				'id'   => $prefix . 'shoplink',
				'type' => 'text_url',
	...
	$meta_boxes['storelocator'] = array(
		'id'         => 'storelocator',
		'title'      => __( 'Stores Metabox', 'cmb' ),
		'pages'      => array( 'store_locator', ), // Post type
		'context'    => 'normal',
		'priority'   => 'high',
		'show_names' => true, // Show field names on the left
		// 'cmb_styles' => true, // Enqueue the CMB stylesheet on the frontend
		'fields'     => array(
			array(
				'name' => __( 'Store Image', 'cmb' ),
				'desc' => __( 'Upload an image or enter a URL.', 'cmb' ),
				'id'   => $prefix . 'store_image',
				'type' => 'file',
			),
			array(
				'name'    => __( 'Store List', 'cmb' ),
				'desc'    => __( '', 'cmb' ),
				'id'      => $prefix . 'list',
				'type'    => 'wysiwyg',
				'options' => array( 'textarea_rows' => 15, ),
