...
<?php screen_icon( 'themes' ); ?><h2><?php _e( 'Core Functions', 'woothemes' ); ?></h2>
...
<form method="post" action="<?php echo esc_url( admin_url( 'admin.php?page=core-functions-manager&updated=true' ) ); ?>">
<?php
wp_nonce_field( 'core-functions-update' );
